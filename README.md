...
| `/stow`            | Sweep the session for uncaptured durable knowledge, route each finding to its role-aware durable owner, file undone next steps to the backlog, and report what is now safe to reset |
