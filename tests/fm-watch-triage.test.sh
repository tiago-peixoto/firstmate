...
# A live grok agent is load-bearing here: a bare shell (zsh/bash) is upstream's
# dead-endpoint once-report (#4775), which is not a wedge and must not be the
# fixture this fold-bound is measured against.
