...
# Answer the mate's earlier decisions and blocker first, including the keyless
# timed ones folded under "default": a recovery repost waits while the mate has
# one of its own open (tests/fm-pending-reply.test.sh).
