...
#   - project cloning never initializes a retired delivery tool in either clone
...
- gamma [direct-PR] - gamma project (added 2026-06-22)
EOF
...
phase_seed() {
  ...
  pass "seed: registry scope+projects, charter copied, and direct-PR clones preserve origins"
}
