...
# read: it reuses bin/fm-crew-state.sh, which may make a bounded legacy compatibility call,
...
# or compatibility tool; absent, it points at the real sibling script.
...
#   working - an attributed legacy background operation or a busy
