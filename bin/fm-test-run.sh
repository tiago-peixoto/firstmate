...
family_for_basename() {
  case "$1" in
    ...
    fm-operational-input.test.sh|fm-pi-primary-types.test.sh|fm-role-context.test.sh|\
    ...
    fm-spawn-meta-publication.test.sh|fm-spawn-prepublication-abort.test.sh|\
