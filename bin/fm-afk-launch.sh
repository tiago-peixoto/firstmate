...
#                            [--grant <task-id>]...#                              Record the captain's away words and mandate
...
#                              ids that may merge-when-green while away.#   fm-afk-launch.sh confirm   Promote the required proposal and print the entry
