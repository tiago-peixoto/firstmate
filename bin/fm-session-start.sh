...
#             projection cleanup and bootstrap's eight mutating sweeps (fleet
#             sync, same-home backlog reconciliation, fork-upstream probing, secondmate convergence and liveness,
