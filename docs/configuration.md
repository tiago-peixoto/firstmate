...
FM_CREW_STATE_NM_TIMEOUT=10   # legacy compatibility timeout for a task recorded under the retired delivery mode
FM_TEARDOWN_NM_TIMEOUT=10    # legacy compatibility timeout during cleanup of a task recorded under the retired delivery mode
FM_CREW_STATE_RUNS_LIMIT=200  # legacy compatibility scan bound for matching an existing run to current code
