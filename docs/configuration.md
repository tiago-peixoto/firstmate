...
FM_SECONDMATE_WAKE_STALL_SECS=60   # minimum age of the oldest valid foreign wake-queue row before secondmate status and live busy state are checked; a last blocked verb always wakes, exact busy suppresses, and idle, dead, or unknown wake conservatively; zero or invalid values use 60
