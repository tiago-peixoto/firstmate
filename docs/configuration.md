...
`bin/fm-git-strip-ai-trailers.sh` owns the identities, the install, and chaining the repository git is actually running in so a project hook such as husky still runs.
