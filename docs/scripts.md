...
| `fm-pr-lib.sh`           | Own canonical task and PR validation plus private atomic PR-monitor publication, observation health, merge-notification identity, and identity-bound retirement |
