...
| `fm-next-cache-sweep.sh` | Report regenerable Next.js build output in pooled worktrees without deleting it     |
| `fm-next-cache-lib.sh`   | Own pooled-worktree Next.js build-output discovery, measurement, and report formatting |
