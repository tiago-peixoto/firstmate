...
| Codex | codex-cli 0.153.4 | Private native app-server | See [Codex native activity](runtime-backends.md#codex-native-activity) for the current launch, failure, recovery and cleanup guard. |
