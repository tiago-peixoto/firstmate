...
| presentation-ready Lavish arm | the adapter starts from an ownerless registration, invokes the generic reconciliation repair, requires two live-owner reads for the exact source before success, refuses another home's live owner with a do-not-present diagnostic, and re-arms an acknowledgement poll without splitting its literal reply |
