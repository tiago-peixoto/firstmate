...
So a delivered ordinary crew task whose last line stays its ready `done` event naming a PR bounds repeated alarms from new pane hashes to the `FM_PAUSE_RESURFACE_SECS` cadence for the length of the captain's decision.
