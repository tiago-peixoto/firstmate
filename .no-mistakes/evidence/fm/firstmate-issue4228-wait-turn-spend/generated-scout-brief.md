...
4. Report status by appending one line:
   `echo "{state} [at=<epoch>]: {one short line}" >> '/tmp/fmbrief.zxQ6/state/live-scout-1.status' && { [ ! -e '/tmp/fmbrief.zxQ6/config/fleet-ledger' ] || '/Users/tiago/.no-mistakes/worktrees/762e4773438f/01M38AFH45XCX7SH6PA8DF77GF/bin/fm-fleet-ledger.sh' appended '/tmp/fmbrief.zxQ6/config' '/tmp/fmbrief.zxQ6/state/live-scout-1.status' >/dev/null 2>&1 || true; }`
...
Firstmate steers you through durable message files in '/tmp/fmbrief.zxQ6/state/live-scout-1.inbox'.
When a terminal message says an instruction is waiting there, list '/tmp/fmbrief.zxQ6/state/live-scout-1.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/tmp/fmbrief.zxQ6/state/live-scout-1.inbox'/NNN.msg '/tmp/fmbrief.zxQ6/state/live-scout-1.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.
Every waiting instruction rings, so never list the inbox on your own.

# Definition of done
Write your findings to `/tmp/fmbrief.zxQ6/data/live-scout-1/report.md`.
...
Before reporting done, read and follow `/Users/tiago/.no-mistakes/worktrees/762e4773438f/01M38AFH45XCX7SH6PA8DF77GF/.agents/skills/captain-hold-lifecycle/SKILL.md` and pass its shared completion gate for the report and any visual review.
