...
- `manual-verification` - load before generating or presenting any captain-facing manual human verification and when handling its Lavish feedback; it owns the private structured artifact, revision-bound handoff, concise chat summary, and result routing.
