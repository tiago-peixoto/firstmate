...
Claude launches always use the default login with CLAUDE_CONFIG_DIR unset, including a leftover config/claude-config-dir; see docs/configuration.md "Account pins"
