...
Next.js build-output reclamation is report-only: `bin/fm-next-cache-sweep.sh` inspects pooled copies and reports how much regenerable output they hold; neither sweep nor teardown deletes it.
