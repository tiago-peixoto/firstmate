...
description: >-
  Handle actionable session-start or `fm-bootstrap.sh` diagnostics, including MISSING, auth, backend, tangle, dispatch, fleet-sync, second-mate, migration, memory-budget, nudge, and FMX lines.
