...
If the targeted current-state read attributes an active background operation to the crew's branch and current code, keep supervising it instead of creating a duplicate worker.
