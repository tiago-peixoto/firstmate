...
5. Relay the choices to the captain as decisions from Bearings' Captain's Call section under `primary-runtime`'s captain-communication contract; do not use the word hold in captain chat.
